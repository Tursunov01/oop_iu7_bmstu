...
QT_MOC_LITERAL(1, 6, 7), // "opening"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 7), // "closing"
QT_MOC_LITERAL(4, 23, 4), // "open"
QT_MOC_LITERAL(5, 28, 5), // "close"
QT_MOC_LITERAL(6, 34, 10), // "start_open"
QT_MOC_LITERAL(7, 45, 11) // "start_close"

    },
    "doors\0opening\0\0closing\0open\0close\0"
    "start_open\0start_close"
};
...
void doors::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->opening(); break;
        case 1: _t->closing(); break;
        case 2: _t->open(); break;
        case 3: _t->close(); break;
        case 4: _t->start_open(); break;
        case 5: _t->start_close(); break;
        default: ;
        }
        ...
        {
            using _t = void (doors::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&doors::opening)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (doors::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&doors::closing)) {
                *result = 1;
                return;
            }
        }
