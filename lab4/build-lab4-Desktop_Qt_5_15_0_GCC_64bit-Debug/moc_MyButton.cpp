...
QT_MOC_LITERAL(1, 9, 11), // "resetButton"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "floorRequest"
QT_MOC_LITERAL(4, 35, 5), // "floor"
QT_MOC_LITERAL(5, 41, 12), // "processPress"
QT_MOC_LITERAL(6, 54, 5) // "reset"

    },
    "MyButton\0resetButton\0\0floorRequest\0"
    "floor\0processPress\0reset"
};
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::resetButton)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::floorRequest)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyButton::resetButton()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyButton::floorRequest(int _t1)
{
